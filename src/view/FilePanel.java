...
//		zone.add(icon, gbc);
//
//		JLabel title = new JLabel("Kéo và thả file vào đây");
...
//		selectedFile = f;
//		fileNameLabel.setText("📄  " + f.getName() + "  (" + (f.length() / 1024 + 1) + " KB)");
