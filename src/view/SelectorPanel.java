...
public class SelectorPanel extends JPanel {
    ...
    public SelectorPanel() {
        ...
        typeCombo = makeCombo(CipherModel.TYPE_TO_ALGOS.keySet().toArray(new String[0]));
        algoCombo = makeCombo(new String[]{"Affine", "Caesar", "Vigenère", "Rail Fence"});
        ...
        paramsPanel.add(new JPanel() {{ setOpaque(false); }}, "EMPTY");
    ...
    private void onTypeChanged() {
        ...
        String[] algos = CipherModel.TYPE_TO_ALGOS.getOrDefault(type, new String[]{"N/A"});
    ...
    private void onAlgoChanged() {
        ...
        if (algo == null) return;
        switch (algo) {
            case "Affine":     cl.show(paramsPanel, "Affine");     break;
            case "Caesar":     cl.show(paramsPanel, "Caesar");     break;
            case "Vigenère":   cl.show(paramsPanel, "Vigenère");   break;
            case "Rail Fence": cl.show(paramsPanel, "Rail Fence"); break;
            default:           cl.show(paramsPanel, "EMPTY");      break;
        }
    }

    public String getSelectedType()  { return (String) typeCombo.getSelectedItem(); }
    public String getSelectedAlgo()  { return (String) algoCombo.getSelectedItem(); }
    public int    getAffineA()       { return (int) spinnerA.getValue(); }
    public int    getAffineB()       { return (int) spinnerB.getValue(); }
    public int    getCaesarShift()   { return (int) spinnerShift.getValue(); }
    public String getVigenereKey()   { return keyField.getText().trim(); }
    public int    getRailCount()     { return (int) spinnerRails.getValue(); }
    ...
    private void styleTextField(JTextField tf) {
        ...
        tf.setBorder(new CompoundBorder(
            new LineBorder(MainFrame.BORDER_CLR),
